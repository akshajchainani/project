...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .chat-header { background: var(--gradient-primary); padding:20px 30px; text-align:center; display: flex; align-items: center; justify-content: center; gap: 10px;}
        ...
        .user-avatar { background: #ffffff; order:2; padding: 4px; box-sizing: border-box;}
        ...
        <div id="chat-container" class="chat-container">
            ...
            <div class="chat-input-container">
                <div class="chat-input">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/5/5a/Mitsubishi_logo.svg" alt="User Logo" class="logo-icon" style="background: white; padding: 4px; box-sizing: border-box;"/>
        ...
        function addUserMessage(message) {
            ...
            messageDiv.innerHTML = `
                <div class="message-avatar user-avatar">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/5/5a/Mitsubishi_logo.svg" alt="User Logo" style="height: 100%; width: 100%;" />
                </div>
...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .logo-icon {
            width: 32px;      /* or your preferred dimension */
            height: 32px;
            border-radius: 50%;    /* makes image round */
            object-fit: cover;     /* ensures the image scales properly */
            margin: 0 8px;         /* decrease spacing (adjust as needed) */
            box-shadow: 0 2px 8px rgba(0,0,0,0.10); /* subtle shadow for aesthetics (optional) */
        }
        .logo-section {
            display: flex;
            align-items: center;
            justify-content: center;
            gap: 10px;  /* reduce from 20px to 10px or lower for tighter spacing */
            margin-bottom: 10px; /* reduce overall space below */
        }


        select, select option {
            color: #333333; /* dark grey for options */
            background-color: #222222; /* dark background for dropdown */
        }
        ...
        .bot-avatar { background: var(--gradient-primary);}
        .message-content { max-width:70%; padding:16px 20px; border-radius:16px; font-size:0.95rem; line-height:1.5;}
        .user-message .message-content { background: var(--accent-blue); color:white; margin-right:auto;}
        .bot-message .message-content { background: var(--glass-bg); backdrop-filter: blur(10px); border:1px solid var(--glass-border); color: var(--text-light);}
        .chat-input-container { padding:20px 30px; background: rgba(0,0,0,0.3); }
        .chat-input { display: flex; gap:12px; align-items:left;}
        .chat-input input {
            flex-grow:1; padding:16px 20px; background:rgba(255,255,255,0.08); border:1px solid var(--glass-border); border-radius:12px; color:var(--text-light); font-size:1rem;
        }
        .chat-input input:focus { outline:none; border-color:var(--primary-red); box-shadow:0 0 0 3px rgba(230,0,18,0.1);}
